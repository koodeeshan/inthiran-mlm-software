...
# --- இணையதள வடிவமைப்பு (Safe & Clean UI) ---
...
# லாகின் செய்த பின் காட்டும் மெம்பர் டேஷ்போர்டு
else:
    current_user = st.session_state.logged_in_user
    user_info = df_net[df_net['Name'] == current_user].iloc[0]
    
    # லாக்-அவுட் மற்றும் வரவேற்பு பகுதி
    ...
    # மெம்பரின் தனிப்பட்ட டேஷ்போர்டு கார்டுகள்
    ...
    if st.button("🔥 விற்பனையை உறுதிசெய் (கமிஷன் பிரி)", use_container_width=True):
        ...
        st.success(f"🎉 Rs.{sale_amount} க்கான விற்பனைப் பதிவு செய்யப்பட்டது! கமிஷன் வெற்றிகரமாகப் பிரித்தளிக்கப்பட்டது.")
        st.rerun()
