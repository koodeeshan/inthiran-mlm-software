# எளிய எம்.எல்.எம் (MLM) கமிஷன் கணக்கீடு
...
class Member:
    ...
    def add_sale(self, amount):
        ...
        self.sales += amount
        print(f"\n{self.name} செய்த விற்பனைத் தொகை: Rs.{amount}")
        
        # 1. சொந்த விற்பனைக்கு 10% கமிஷன்
        own_commission = amount * 0.10
        self.earnings += own_commission
        print(f"-> {self.name} பெற்ற நேரடி கமிஷன் (10%): Rs.{own_commission}")
        ...
        while current_sponsor and level in commission_rates:
            ...
            print(f"-> லெவல் {level} ஸ்பான்சர் {current_sponsor.name} பெற்ற கமிஷன் ({rate*100}%): Rs.{indirect_commission}")
...
# லெவல் 0: நிறுவனத்தின் முதன்மை நபர் (உதாரணமாக உங்கள் பெயர்)
...
# --- இறுதி வருமான நிலை ---
print("\n" + "="*35)
print("  ஒவ்வொருவரின் இறுதி வருமானம்")
print("="*35)
print(f"{boss.name} இன் மொத்த வருமானம்: Rs.{boss.earnings}")
print(f"{member_a.name} இன் மொத்த வருமானம்: Rs.{member_a.earnings}")
print(f"{member_b.name} இன் மொத்த வருமானம்: Rs.{member_b.earnings}")
